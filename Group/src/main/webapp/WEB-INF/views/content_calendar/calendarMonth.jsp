...
<%@ page import="com.group.dao.CalendarDao" %>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
	    ...
	    for(int iy=iTYear-5;iy<=iTYear+10;iy++)
		{
		  if(iy==iYear)
		  {
		    %>
	   ...
	   %>
        ...
        <td width="73%" align="center"><h3><%=iYear%>-<%=new SimpleDateFormat("MM").format(new Date(2017,iMonth,01))%></h3></td>
        <td width="6%">Month</td>
        <td width="8%">
	    ...
	    for(int im=0;im<=11;im++)
		{
		  ...
		  {
	     %>
          <option value="<%=im%>" selected="selected"><%=new SimpleDateFormat("MM").format(new Date(2017,im,01))%></option>
          <%
		  }
		  else
		  {
		    %>
          <option value="<%=im%>"><%=new SimpleDateFormat("MM").format(new Date(2008,im,01))%></option>
          <%
		  }
		}
	   %>
...
// 		        	date = ""+iYear;
// 		        	date += dao.zeroNumber(iMonth);
// 		        	date += dao.zeroNumber((cnt-weekStartDay+1));
//                		String event = dao.isLunar(date);
               		
//                		if(event==null){
//                			event = dao.isSun(date);
//                			if(event==null){
//                				event="";
//                			}
//                		}
...
<%--                 	<span><small><%=event%></small></span><br> --%>
