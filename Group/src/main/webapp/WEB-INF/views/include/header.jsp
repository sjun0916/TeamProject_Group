...
>>>>>>> branch 'master' of https://github.com/sjun0916/TeamProject_Group.git
			...
			<a href="/group/home" class="logo"> <!-- 메인바가 미니가 되었을때 로고 형태 -->
				<span class="logo-mini"><b>★</b></span> <!-- 로고 형태 --> <span
				class="logo-lg"><b>Hello</b>IT</span>
			</a>
			...
			<nav class="navbar navbar-static-top" role="navigation">
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						<li><c:choose>
								<c:when test="${sessionScope.authUser.employeeNo} == null}">
									<a href="/group">로그인</a>
								</c:when>
								<c:otherwise>
       <b><c:out value="${sessionScope.authUser.employeeName}"/></b>님이 로그인중입니다.
...
<<<<<<< HEAD
									<p>
										TEST - Web Developer <small>Member since 2017</small>
									</p></li>
								<!-- 유저 정보 메뉴 -->
								<li class="user-footer">
									<div class="row">
...
<<<<<<< HEAD
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a href="#"> <i class="fa fa-dashboard"></i> <span>사원
								주소록</span>
					</a></li>
					...
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a href="/group/mail/mailForm"><i
									class="fa fa-circle-o"></i> 메일쓰기</a></li>
					...
					<li><a href="#"> <i class="fa fa-dashboard"></i> <span>사진첩</span>
					</a></li>

					<li><hr></li>

					<c:if test="${ authUser.getRole() == 'ADMIN' }">
						<li><a href="#"> <i class="fa fa-laptop"></i> <!--         	<i class="fa fa-gear"></i> -->
								<span>관리자 설정</span>
						</a></li>
					</c:if>
				</ul>
