		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">임시저장문서</h3>
					<span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-up"></i></span>
				</div>
			<div class="panel-body">
				<form role="form" action="<c:url value='/ap/add'/>" enctype="multipart/form-data" method="post" >
			    	<div class="form-group">
						<div class="col-md-12">
							...
							<input type="text" class="form-control" name="mmCode" value="${draft[0].mmCode}" readonly="readonly" >
						</div>				
					</div>
					<div class="form-group">
						<div class="col-md-12">
					...
					<div class="col-md-12">
						...
						<div class="form-group" align="center">
							<button type="submit" class="btn-success btn-lg" align="center"> 기안 재요청 </button>
						</div>
		    		</form>
				</div>
			</div>
