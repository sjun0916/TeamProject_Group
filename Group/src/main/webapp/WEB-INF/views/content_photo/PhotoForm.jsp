...
<div class="content-wrapper">
	...
	<div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" name="form1" action="PhotoSave" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="title" name="title" value="<c:out value="${photoInfo.title}"/>" placeholder = "제목을 입력해주세요.">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <c:forEach var="listview" items="${listview}" varStatus="status">
								<input type="checkbox" name="photofilenum" class="form-control" value="<c:out value="${listview.photofilenum}"/>">
								<a href="fileDownload2?filename=<c:out value="${listview.filename}"/>&downname=<c:out value="${listview.realname }"/>">
				...
				<input type="hidden" name="photonum" value="<c:out value="${photoInfo.photonum}"/>">
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
              	<button type="button" class="btn btn-default" onClick="history.back();">돌아가기</button>
                <button type="button" class="btn btn-info pull-right" onclick="fn_formSubmit()">사진등록</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
