        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-aqua">
            ...
            <div class="info-box-content">
              ...
              <br>
                  <small><a href="#" class="small-box-footer pull-right">More info <i class="fa fa-arrow-circle-right"></i></a></small>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
              	<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <button type="button" class="btn btn-box-tool"onclick="location.href='/group/PhotoList'">more<i class="fa fa-chevron-circle-right"></i></button>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="table-responsive">
				...
				<table width="450">
					...
					<c:forEach var="listview" items="${listview4}" varStatus="status">
						...
						<tr>
						<td><small>제목:&nbsp;<a href="${link}"><c:out value="${listview.title}" /></a></small>
						</td>
						</tr>
						<tr>
						<td><small>작성자:&nbsp;[<c:out value="${listview.departname}"/>]
          ...
          <div class="box box-default">
            ...
            <div class="box-footer no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#">링크 <span class="pull-right text-green"><i class="fa fa-angle-up"></i> 4%</span></a>
                </li>
                <li><a href="#">링크
